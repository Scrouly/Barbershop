...
class Customer(models.Model):
    ...
    user = models.OneToOneField(User, verbose_name="Клиент", on_delete=models.CASCADE, null=True, blank=True)
    def __str__(self):
...
class Employees(models.Model):
    ...
    user = models.OneToOneField(User, verbose_name="Барбер", on_delete=models.CASCADE, null=True, blank=True)
